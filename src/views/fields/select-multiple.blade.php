...
<div class="form-group">
    ...
    <select name="{{ $field['field'] }}[]" id="{{ $field['field'] }}" class="form-control {{ $field['required'] ? 'jcrud-frm-item-required' : '' }}" {{ $field['required'] ? 'required' : '' }} multiple="true" jcrud-data-title="{{ ucfirst(trans('messages.'.$field['title'])) }}">
